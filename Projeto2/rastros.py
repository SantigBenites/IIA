...
def jogaRastrosNN(listaJog, listaAdv, n=1,nsec=1):
...
def num_livres(estado,jogador) :
    """Se ganha 10, se perde -10 senão maximiza o espaço livre junto à peça B"""
...
def faz_campeonato(listaJogadores, n=1, nsec=10):
    ### faz todos os jogos com timeout de nsec por jogada
    campeonato = jogaRastrosNN(listaJogadores, listaJogadores, n, nsec)
